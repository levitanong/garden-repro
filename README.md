...
`src/main/garden_repro/client.cljs` contains the code to start and refresh
...
application `garden-repro.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/garden_repro.jar
```
